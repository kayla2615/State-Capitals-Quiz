...
public class QuizDataDBHelper extends SQLiteOpenHelper {
    ...
    public static final String QUIZDATA_COLUMN_NAME = "name";
    public static final String QUIZDATA_COLUMN_PHONE = "phone";
    public static final String QUIZDATA_COLUMN_URL = "url";
    public static final String QUIZDATA_COLUMN_COMMENTS = "comments";
    ...
    private static final String CREATE_QUIZDATA =
            "create table " + TABLE_QUIZDATA + " ("
                    ...
                    + QUIZDATA_COLUMN_NAME + " TEXT, "
                    + QUIZDATA_COLUMN_PHONE + " TEXT, "
                    + QUIZDATA_COLUMN_URL + " TEXT, "
                    + QUIZDATA_COLUMN_COMMENTS + " TEXT"
                    + ")";
